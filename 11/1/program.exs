...
defmodule Program do
  ...
  def rounds(octopuses, rounds_left \\ 0, flashes \\ 0)

  def rounds(octopuses, 0, flashes), do: {octopuses, flashes}

  def rounds(octopuses, rounds_left, flashes) do
    octopuses = next_round(octopuses)
    round_flashes = Matrix.count(octopuses, & &1 == 0)
    rounds(octopuses, rounds_left - 1, flashes + round_flashes)
  end
